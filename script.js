    ...
    fetch(
        ...
        .then((data) => {
            ...
            if (data.features[0] != null) {
                ...
                // Address
                const fullAddress = data.features[0].properties.display_name;
                const addressElement = document.createElement("div");
                addressElement.classList.add("sidebarContentTable");
                addressElement.setAttribute("data-tooltip", "Copy address");
                ...
                <div class="sidebarIconText">${fullAddress}</div>`;
                ...
                if (data.features[0].properties.extratags.phone != null) {
                    ...
                    phoneElement.setAttribute(
                        "onclick",
                        `navigator.clipboard.writeText('${data.features[0].properties.extratags.phone}')`
                    );
                ...
                if (data.features[0].properties.extratags.website != null) {
                    ...
                    websiteElement.setAttribute("data-tooltip", "Copy website");
                    websiteElement.setAttribute(
                        "onclick",
                        `navigator.clipboard.writeText('${data.features[0].properties.extratags.website}')`
                    );
                    ...
                    <div class="sidebarIconText">
                    <a href="${data.features[0].properties.extratags.website}" class="links" target="_blank">${data.features[0].properties.extratags.website}
                    </a></div>`;
